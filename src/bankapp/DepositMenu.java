    ...
    private void depositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositButtonActionPerformed
        ...
        if (amountField.getText().isEmpty()) {
            ...
            try {
                ...
                int result = JOptionPane.showConfirmDialog(this, "Deposit Rs." + String.format("%.2f", amount) + " to the account?\nInterest Earned: Rs." + String.format("%.2f", (bank.checkInterest(customer.getAccount().getBalance(), amount) * amount)));
