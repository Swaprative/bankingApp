        ...
        if (warnings.length() > 0) {
            ...
            if (typeField.getSelectedItem().toString() == "Current") {
                if (amount >= 100) {
                    ...
                    warnings.append("Initial deposit must be at least Rs.100 for Checking accounts.");
                }
            } else if (typeField.getSelectedItem().toString() == "Savings") {
                if (amount >= 50) {
                    accountType = AccountType.Savings;
                } else {
                    warnings.append("Initial deposit must be at least Rs.50 for Savings accounts.");
                }
            }
